  ...
  return (
    <div className="mt-6 bg-white rounded-lg p-4">
      <table className="w-full text-left border-collapse">
        <caption className="text-lg font-semibold p-4 text-gray-700">
          Total income from rooms and events bookings
        </caption>
        <thead>
          <tr>
            <th className="border-b p-2 text-black">Month</th>
            <th className="border-b p-2 text-black">Room Income</th>
            <th className="border-b p-2 text-black">Event Income</th>
            <th className="border-b p-2 text-black">Total Income</th>
          </tr>
        </thead>
        <tbody>
          {data.map((row) => (
            <tr key={row.id} className="hover:bg-gray-50">
              <td className="border-b p-2 text-black">{row.month}</td>
